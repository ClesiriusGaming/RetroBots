...
if(message.content.startsWith(prefix + "servlist")){
  ...
  const embed = new Discord.RichEmbed()
   ...
   .setFooter("TeamSecurity®『🚫』", bot.user.displayAvatarURL)
   .setTimestamp()
...
if(message.content.startsWith(prefix + "say")){
	...
	message.channel.send(text)
      ...
      if (message.content.startsWith(prefix + "vcs")) {
        ...
        if(!message.guild.channels.find("name", "vcs-secu")) return message.reply("Erreur, le channel vcs-security est introuvable");
        if(message.channel.name !== "vcs-secu") return message.reply("Commande à effectuer dans vcs-secu");
        ...
        .setColor("RANDOM")
        .setAuthor("TeamSecurity BOT - VCS", bot.user.avatarURL)
        .addField("Serveur", message.guild.name, true)
        .addField("Utilisateur", message.author.tag, true)
        .addField("Message", vcsmsg)
        .setFooter("TeamSecurity®『🚫』", bot.user.displayAvatarURL)
        .setTimestamp()
        bot.channels.findAll('name', 'vcs-secu').map(channel => channel.send(embed)) 
          }
...
        var embed = new Discord.RichEmbed()
        .setColor("RANDOM")
        .setAuthor("TeamSecurity BOT - INFO", bot.user.avatarURL)
